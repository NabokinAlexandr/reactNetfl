...
import './popup-add-movie.css';
import Modal from 'react-bootstrap/Modal';
import Form from 'react-bootstrap/Form';
import Button from 'react-bootstrap/Button';

function PopUpAddMovie(props) {
  const form = {
    id: null,
    title: '',
    releaseDate: null,
  ...
  const [movieData, setMovieData] = useState(props.location === 'addForm' ? form : props.movie);
  ...
  return (
    <Modal show={props.isOpen}>
      ...
      {props.location === 'addForm' ? ( <Modal.Title>ADD MOVIE</Modal.Title>) : (
        <Modal.Title>Edit movie</Modal.Title>)}
      </Modal.Header>
      <Modal.Body>
        {/* <Form>
          <Form.Group> */}
          {props.location === 'addForm' ? null : (
            <>
